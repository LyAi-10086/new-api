...
const defaultModelSettings: ModelSettings = {
  ...
  'channel_alert_setting.window_seconds': 60,
  'channel_alert_setting.failure_threshold': 3,
  'channel_alert_setting.cooldown_seconds': 1800,
  'channel_alert_setting.recovery_enabled': true,
  'channel_alert_setting.recovery_cooldown_seconds': 1800,
  'channel_alert_setting.status_codes': '401,403,429,500-599',
  'channel_alert_setting.keywords': '[]',
  'channel_alert_setting.include_relay_errors': true,
  'channel_alert_setting.include_scheduled_tests': true,
  'channel_alert_setting.include_manual_tests': false,
