...
func PostTextConsumeQuota(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, usage *dto.Usage, extraContent []string) {
	...
	if summary.TotalTokens == 0 {
		...
		summary.Quota = ApplyTimePricingToQuota(relayInfo, summary.Quota)
		if timePricingText := TimePricingLogText(relayInfo); timePricingText != "" {
			extraContent = append(extraContent, timePricingText)
		}
	...
	InjectTimePricingLogInfo(other, relayInfo)
